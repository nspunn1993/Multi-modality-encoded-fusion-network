...
def get_training_and_validation_generators(data_file, batch_size, n_labels, training_keys_file, validation_keys_file,
    ...
    """
    write_initlog("get_training_and_validation_generators ")
    ...
    write_initlog("training_list, validation_list "+str(len(training_list))+" "+str(len(validation_list)))
    ...
    write_initlog("Number of training steps: "+str(training_generator[0].shape)+" "+str(training_generator[1].shape))
    write_initlog("Number of validation steps: "+str(validation_generator[0].shape)+" "+str(validation_generator[1].shape))
...
def get_validation_split(data_file, training_file, validation_file, data_split=0.8, overwrite=False):
    ...
    :return:
    """
    write_initlog("Get Validation Split: "+str(overwrite or not os.path.exists(training_file)))
    if overwrite or not os.path.exists(training_file):
        write_initlog("Creating validation split...")
        ...
        write_initlog("Loading previous validation split...")
